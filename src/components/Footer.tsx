    ...
    <footer className="bg-church-900 dark:bg-[#0a0608] text-white">
      ...
      <div className="container-max mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Location Column */}
          <div>
            <h3 className="text-xs font-bold uppercase tracking-widest text-white mb-6">Visit Us</h3>
          ...
          {/* Worship Column */}
          <div>
            <h3 className="text-xs font-bold uppercase tracking-widest text-white mb-6">Worship</h3>
          ...
          {/* About Column */}
          <div>
            <h3 className="text-xs font-bold uppercase tracking-widest text-white mb-6">About</h3>
            <nav className="space-y-3 text-sm">
